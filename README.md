...
**Note:** As of October 4, 2021, SAS no longer supports the SAS Grid on the AWS Cloud QuickStart. After this date, there is no expectation that this QuickStart will be functional. Rather, it will be available as a reference architecture only.
